import { SvgIcon, SvgIconProps, Icon as MuiIcon, IconProps as MuiIconProps, IconButton, IconButtonProps } from "@mui/material";

import Image from "next/image";
import ItchIconSvg from "~/assets/brands/itchio-black.svg"
...
export type IconProps = {
	...
	{ href: undefined }
	| Omit<LinkProps, "href" | keyof IconButtonProps> & {
		href: string,
	}
)

const ItchIcon = (props: SvgIconProps) => (
	<SvgIcon {...props}>
...
const LinkedinIcon = (props: MuiIconProps) => (
	<MuiIcon
		{...props}
...
const TwitterIcon = (props: MuiIconProps) => (
	<MuiIcon
		{...props}
...
export default function Icon(props: IconProps) {
	...
	const Container = href
		? ({ children }: { children: React.ReactNode }) => <IconButton component={Link} href={href} {...rest}>{children}</IconButton>
